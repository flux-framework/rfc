...
Existing Equivalents
   +-----------------------------------+-----------------------------------+
   | Slurm (a)                         | ``srun -N4 --sockets-per-node=2 - |
   |                                   | -cores-per-socket=4``             |
   +-----------------------------------+-----------------------------------+
   | Slurm (b)                         | ``srun -N4 -B '2:4:*'``           |
   +-----------------------------------+-----------------------------------+
   | OAR                               | ``oarsub -l nodes=4/sockets=2/cor |
   |                                   | es=4``                            |
   +-----------------------------------+-----------------------------------+
...
Existing Equivalents
   +-----------------------------------+-----------------------------------+
   | OAR                               | ``oarsub -I -l "{memnode=4096 and |
   |                                   |  ib10g='YES'}/cluster=1/nodes=2/c |
   |                                   | ore=1+{nbcore=2}/switch=1/nodes=2 |
   |                                   | /cpu=1,walltime=4:0:0"``          |
   +-----------------------------------+-----------------------------------+
...
Existing Equivalents
   +-----------------------------------+-----------------------------------+
   | Slurm                             | ``srun -n 10 --mem-per-cpu=2048 a |
   |                                   | pp``                              |
   +-----------------------------------+-----------------------------------+
...
Existing Equivalents
   ...
   +-----------------------------------+-----------------------------------+
   | OAR                               | ``oarsub -p memnode=4096 -l nodes |
   |                                   | =2 "taktuk -c oarsh -f $OAR_FILE_ |
   |                                   | NODES broadcast exec [app]"``     |
   +-----------------------------------+-----------------------------------+
