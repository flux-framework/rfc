...
**xor_slot**
   ...
   reserved. Each ``xor_slot`` represents a normal ``slot`` candidate, and the 
   flexible traverser tries the expanded branches sequentially until a match 
   is found (first-match strategy).
